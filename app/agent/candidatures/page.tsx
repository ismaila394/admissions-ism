...
import { Search, Eye, CheckCircle, AlertCircle, FileText, User, Phone, Mail, MapPin, GraduationCap } from "lucide-react"
      ...
      <div className="p-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-1">
            Verifiez et traitez les candidatures soumises
          </p>
        </div>
