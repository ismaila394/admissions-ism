...
import { Search, Eye, CheckCircle, XCircle, FileText, User, Phone, Mail, MapPin, GraduationCap } from "lucide-react"
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        <div className="flex items-center gap-3">
                          ...
                          <Badge className={statusConfig.verifiee.color}>
                            {statusConfig.verifiee.label}
                          </Badge>
                        </div>
